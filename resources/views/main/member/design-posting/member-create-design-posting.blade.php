    ...
    <section>
        ...
        <div class="container">
            ...
            <div>
                ...
                <!--Content-->
                <form action="{{ route('member.design-posting.create')}}" enctype="multipart/form-data" method="post">
                    {{csrf_field()}}
                    <div class="container">
                        ...
                        <div class="row">
                            ...
                            <div class="col mt-4" style="border-color: gainsboro; border-style: solid; border-width: 1px; border-radius: 10px; padding: 20px; margin: 10px;">
                                ...
                                <div class="form-check" style="margin-top: 32px;">
                                    <input class="form-check-input" type="radio" value="0" name="is_free" required>
                                ...
                                <div class="form-check" style="margin-top: 32px;">
                                    <input class="form-check-input" type="radio" value="1" name="is_free" required>
                                    <label class="form-check-label" for="flexRadioDefault1">
                                        <h5>Free Pack</h5>
                                    </label>
                        ...
                        <div class="row">
                            ...
                            <div class="col" style="border-color: gainsboro; border-style: solid; border-width: 1px; border-radius: 10px; padding: 20px; margin: 10px;">
                                ...
                                <div class="mb-2" style="margin-top: 32px;">
                                    ...
                                    <input type="text" class="form-control" name="title" placeholder="Pick a name that describes the topic of your pack e.g Avatar, School & education, UI controls." required>
                                </div>

                                <div class="mb-3" style="margin-top: 32px;">
                                    <label for="exampleFormControlTextarea1" class="form-label">Pack Description</label>
                                    <textarea class="form-control" name="description" rows="3" placeholder="Use this field to provide additional information on how to get the most of this pack" required></textarea>
                                </div>
                        ...
                        <div class="row">
                            <div class="col mt-4" style="border-color: gainsboro; border-style: solid; border-width: 1px; border-radius: 10px; padding: 20px; margin: 10px;">
                                ...
                                <div class="form-check" style="margin-top: 32px;">
                                    <input class="form-check-input" type="radio" value="illustration" name="type" required>
                                    <label class="form-check-label" for="flexRadioDefault1">
                                        <h5>Illustration</h5>
                                    </label>
                                </div>
                                ...
                                <div class="form-check" style="margin-top: 32px;">
                                    <input class="form-check-input" type="radio" value="webDesign" name="type" required>
                                    <label class="form-check-label" for="flexRadioDefault1">
                                        <h5>Web Design</h5>
                                    </label>
                                </div>
                        ...
                        <div class="d-grid gap-2" style="margin-top: 32px;">
                            <button type="submit" style="background-color: #4F7AF6;" class="btn btn-primary">Upload Design</button>
                        </div>
